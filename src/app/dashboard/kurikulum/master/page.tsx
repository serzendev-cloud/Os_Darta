          ...
          {filteredCurriculums.map((prog) => (
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 rounded-2xl bg-stone-50 dark:bg-stone-800/80 border border-stone-200/60 dark:border-stone-700 text-[11px] space-y-2">
                  <div className="font-bold text-stone-700 dark:text-stone-300 text-[10px] uppercase tracking-wider flex items-center justify-between">
